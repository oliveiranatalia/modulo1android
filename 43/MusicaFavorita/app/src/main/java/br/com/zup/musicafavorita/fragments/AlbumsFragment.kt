...
import br.com.zup.musicafavorita.fragments.recyclerViewAdapter.AlbumAdapter
import br.com.zup.musicafavorita.model.Album

class AlbumsFragment : Fragment() {
    private lateinit var binding: FragmentAlbumsBinding
    private val albumAdapter:AlbumAdapter by lazy {AlbumAdapter(arrayListOf(), ::getDetails)}
    ...
    private fun getDetails(album:Album){
        val bundle = bundleOf(KEY to album)
        NavHostFragment.findNavController(this).navigate(R.id.action_albumsFragment_to_albumDetailFragment,bundle)
    }
}